...
day= 'BL1'; %rat_index(:,6)
rat='1962'; %rat_index(:,3)
line='CDKL5'; %rat_index(:,4)
ratname=[line '_' rat];
rat_ind=['rat_day_index_' line '.csv']
pno='C:\Users\ibull\Documents\POSTDOC\ANALISYS\EEG RESULTS\For Igor'; % Set dir for index data .csv file
cd(pno);
T = readtable(rat_ind);
...
if x==1
   ...
   TAINI_autodetect(cn1,pn,pna,pno,day,ratname,line,T,k,rat_index,Num_index)
end
