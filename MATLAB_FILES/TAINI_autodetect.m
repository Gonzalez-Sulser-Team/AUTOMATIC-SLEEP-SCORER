...
function TAINI_autodetect(cn1,pn,pna,day,ratname,line,T,k,rat_index,Num_index)
...
eegch=eegch';
samprate=250;
cepstral_analysis(eegch,samprate,ratname,day,line,pn,pna,Taini_correction,T,k,rat_index,Num_index)
